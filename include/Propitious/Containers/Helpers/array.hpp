...
namespace Propitious
{
	namespace Memory
	{
		...
		template <typename T>
		vol capacity(const Array<T>& array);
		...
		template <typename T>
		T& front(const Array<T>& array);
		template <typename T>
		const T& front(const Array<T>& array);

		template <typename T>
		T& back(const Array<T>& array);
		template <typename T>
		...
		template <typename T>
		void reserve(Array<T>& array, vol capacity);

		template <typename T>
		void grow(Array<T>& array, vol minCapacity = 0);

		template <typename T>
		void trim(Array<T>& array);
