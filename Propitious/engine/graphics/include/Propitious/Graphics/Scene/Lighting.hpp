...
{
	struct PROPITIOUS_GRAPHICS_EXPORT Attenuation
	{
		f32 constant = 1.0f;
		f32 linear = 0.0f;
		f32 quadratic = 1.0f;
	...
	struct PROPITIOUS_GRAPHICS_EXPORT BaseLight
	{
		Colour colour = Colour{ 255, 255, 255 };
		f32 brightness = 1.0f;
	};

	struct PROPITIOUS_GRAPHICS_EXPORT DirectionalLight : BaseLight
	{
		Vector3 direction;
	};

	struct PROPITIOUS_GRAPHICS_EXPORT PointLight : BaseLight
	{
	...
	struct PROPITIOUS_GRAPHICS_EXPORT SpotLight : PointLight
	{
