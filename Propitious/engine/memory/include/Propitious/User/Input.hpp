...
{
	enum class PROPITIOUS_MEMORY_EXPORT Key
	{
	...
	enum PROPITIOUS_MEMORY_EXPORT MouseButton : u8
	{
		Mouse_1 = 0,
		Mouse_2 = 1,
		Mouse_3 = 2,
	...
	enum class PROPITIOUS_MEMORY_EXPORT CursorMode
	{
		Normal,
		Hidden,
		Disabled
	...
	namespace Input
	{
		...
		PROPITIOUS_MEMORY_EXPORT bool getKey(Key key);

		PROPITIOUS_MEMORY_EXPORT bool getMouseButton(MouseButton button);

		PROPITIOUS_MEMORY_EXPORT Vector2 getScrollOffset();

		PROPITIOUS_MEMORY_EXPORT Vector2 getCursorPosition();
		//useful Vector2 getCursorPosition(Window& relativeTo);

		PROPITIOUS_MEMORY_EXPORT void setCursorPosition(const Vector2& position);
