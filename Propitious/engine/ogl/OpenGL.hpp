#ifndef PROPITIOUS_GRAPHICS_OPENGLIMP_HPP
#define PROPITIOUS_GRAPHICS_OPENGLIMP_HPP
...
#ifndef GLAPI
#define GLAPI PROPITIOUS_EXPORT extern
#endif
...
#include <inttypes.h>
	...
	namespace OpenGL
	{
		...
		namespace _detail
		{
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendFunc)(GLenum sfactor, GLenum dfactor);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Clear)(GLbitfield mask);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearDepth)(GLdouble depth);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearStencil)(GLint s);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ColorMask)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CullFace)(GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DepthFunc)(GLenum func);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DepthMask)(GLboolean flag);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DepthRange)(GLdouble ren_near, GLdouble ren_far);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Disable)(GLenum cap);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawBuffer)(GLenum buf);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Enable)(GLenum cap);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Finish)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Flush)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FrontFace)(GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetBooleanv)(GLenum pname, GLboolean * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetDoublev)(GLenum pname, GLdouble * data);
			PROPITIOUS_EXPORT extern GLenum(CODEGEN_FUNCPTR *GetError)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetFloatv)(GLenum pname, GLfloat * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetIntegerv)(GLenum pname, GLint * data);
			PROPITIOUS_EXPORT extern const GLubyte * (CODEGEN_FUNCPTR *GetString)(GLenum name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexImage)(GLenum target, GLint level, GLenum format, GLenum type, void * pixels);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexLevelParameterfv)(GLenum target, GLint level, GLenum pname, GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexLevelParameteriv)(GLenum target, GLint level, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexParameterfv)(GLenum target, GLenum pname, GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexParameteriv)(GLenum target, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Hint)(GLenum target, GLenum mode);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsEnabled)(GLenum cap);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *LineWidth)(GLfloat width);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *LogicOp)(GLenum opcode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PixelStoref)(GLenum pname, GLfloat param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PixelStorei)(GLenum pname, GLint param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PointSize)(GLfloat size);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PolygonMode)(GLenum face, GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ReadBuffer)(GLenum src);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ReadPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void * pixels);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Scissor)(GLint x, GLint y, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *StencilFunc)(GLenum func, GLint ref, GLuint mask);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *StencilMask)(GLuint mask);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *StencilOp)(GLenum fail, GLenum zfail, GLenum zpass);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexImage1D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void * pixels);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexImage2D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void * pixels);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexParameterf)(GLenum target, GLenum pname, GLfloat param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexParameterfv)(GLenum target, GLenum pname, const GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexParameteri)(GLenum target, GLenum pname, GLint param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexParameteriv)(GLenum target, GLenum pname, const GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Viewport)(GLint x, GLint y, GLsizei width, GLsizei height);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindTexture)(GLenum target, GLuint texture);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteTextures)(GLsizei n, const GLuint * textures);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawArrays)(GLenum mode, GLint first, GLsizei count);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElements)(GLenum mode, GLsizei count, GLenum type, const void * indices);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenTextures)(GLsizei n, GLuint * textures);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetPointerv)(GLenum pname, void ** params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsTexture)(GLuint texture);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PolygonOffset)(GLfloat factor, GLfloat units);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void * pixels);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void * pixels);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawRangeElements)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexImage3D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void * pixels);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void * pixels);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ActiveTexture)(GLenum texture);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompressedTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompressedTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompressedTexImage3D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompressedTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompressedTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompressedTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetCompressedTexImage)(GLenum target, GLint level, void * img);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SampleCoverage)(GLfloat value, GLboolean invert);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendEquation)(GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendFuncSeparate)(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MultiDrawArrays)(GLenum mode, const GLint * first, const GLsizei * count, GLsizei drawcount);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MultiDrawElements)(GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei drawcount);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PointParameterf)(GLenum pname, GLfloat param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PointParameterfv)(GLenum pname, const GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PointParameteri)(GLenum pname, GLint param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PointParameteriv)(GLenum pname, const GLint * params);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BeginQuery)(GLenum target, GLuint id);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindBuffer)(GLenum target, GLuint buffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BufferData)(GLenum target, GLsizeiptr size, const void * data, GLenum usage);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteBuffers)(GLsizei n, const GLuint * buffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteQueries)(GLsizei n, const GLuint * ids);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *EndQuery)(GLenum target);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenBuffers)(GLsizei n, GLuint * buffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenQueries)(GLsizei n, GLuint * ids);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetBufferParameteriv)(GLenum target, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetBufferPointerv)(GLenum target, GLenum pname, void ** params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetQueryObjectiv)(GLuint id, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetQueryObjectuiv)(GLuint id, GLenum pname, GLuint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetQueryiv)(GLenum target, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsBuffer)(GLuint buffer);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsQuery)(GLuint id);
			PROPITIOUS_EXPORT extern void * (CODEGEN_FUNCPTR *MapBuffer)(GLenum target, GLenum access);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *UnmapBuffer)(GLenum target);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *AttachShader)(GLuint program, GLuint shader);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindAttribLocation)(GLuint program, GLuint index, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendEquationSeparate)(GLenum modeRGB, GLenum modeAlpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CompileShader)(GLuint shader);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *CreateProgram)(void);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *CreateShader)(GLenum type);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteProgram)(GLuint program);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteShader)(GLuint shader);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DetachShader)(GLuint program, GLuint shader);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DisableVertexAttribArray)(GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawBuffers)(GLsizei n, const GLenum * bufs);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *EnableVertexAttribArray)(GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveAttrib)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveUniform)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetAttachedShaders)(GLuint program, GLsizei maxCount, GLsizei * count, GLuint * shaders);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetAttribLocation)(GLuint program, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramInfoLog)(GLuint program, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramiv)(GLuint program, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetShaderInfoLog)(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetShaderSource)(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * source);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetShaderiv)(GLuint shader, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetUniformLocation)(GLuint program, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetUniformfv)(GLuint program, GLint location, GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetUniformiv)(GLuint program, GLint location, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribPointerv)(GLuint index, GLenum pname, void ** pointer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribdv)(GLuint index, GLenum pname, GLdouble * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribfv)(GLuint index, GLenum pname, GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribiv)(GLuint index, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsProgram)(GLuint program);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsShader)(GLuint shader);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *LinkProgram)(GLuint program);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ShaderSource)(GLuint shader, GLsizei count, const GLchar *const* string, const GLint * length);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *StencilFuncSeparate)(GLenum face, GLenum func, GLint ref, GLuint mask);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *StencilMaskSeparate)(GLenum face, GLuint mask);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *StencilOpSeparate)(GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1f)(GLint location, GLfloat v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1fv)(GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1i)(GLint location, GLint v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1iv)(GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2f)(GLint location, GLfloat v0, GLfloat v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2fv)(GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2i)(GLint location, GLint v0, GLint v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2iv)(GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3f)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3fv)(GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3i)(GLint location, GLint v0, GLint v1, GLint v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3iv)(GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4f)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4fv)(GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4i)(GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4iv)(GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UseProgram)(GLuint program);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ValidateProgram)(GLuint program);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib1d)(GLuint index, GLdouble x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib1dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib1f)(GLuint index, GLfloat x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib1fv)(GLuint index, const GLfloat * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib1s)(GLuint index, GLshort x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib1sv)(GLuint index, const GLshort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib2d)(GLuint index, GLdouble x, GLdouble y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib2dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib2f)(GLuint index, GLfloat x, GLfloat y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib2fv)(GLuint index, const GLfloat * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib2s)(GLuint index, GLshort x, GLshort y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib2sv)(GLuint index, const GLshort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib3dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib3f)(GLuint index, GLfloat x, GLfloat y, GLfloat z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib3fv)(GLuint index, const GLfloat * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib3s)(GLuint index, GLshort x, GLshort y, GLshort z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib3sv)(GLuint index, const GLshort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Nbv)(GLuint index, const GLbyte * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Niv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Nsv)(GLuint index, const GLshort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Nub)(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Nubv)(GLuint index, const GLubyte * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Nuiv)(GLuint index, const GLuint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4Nusv)(GLuint index, const GLushort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4bv)(GLuint index, const GLbyte * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4f)(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4fv)(GLuint index, const GLfloat * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4iv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4s)(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4sv)(GLuint index, const GLshort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4ubv)(GLuint index, const GLubyte * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4uiv)(GLuint index, const GLuint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttrib4usv)(GLuint index, const GLushort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribPointer)(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void * pointer);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix2x3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix2x4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix3x2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix3x4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix4x2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix4x3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BeginConditionalRender)(GLuint id, GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BeginTransformFeedback)(GLenum primitiveMode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindBufferBase)(GLenum target, GLuint index, GLuint buffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindBufferRange)(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindFragDataLocation)(GLuint program, GLuint color, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindFramebuffer)(GLenum target, GLuint framebuffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindRenderbuffer)(GLenum target, GLuint renderbuffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindVertexArray)(GLuint ren_array);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlitFramebuffer)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
			PROPITIOUS_EXPORT extern GLenum(CODEGEN_FUNCPTR *CheckFramebufferStatus)(GLenum target);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClampColor)(GLenum target, GLenum clamp);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearBufferfi)(GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearBufferfv)(GLenum buffer, GLint drawbuffer, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearBufferiv)(GLenum buffer, GLint drawbuffer, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearBufferuiv)(GLenum buffer, GLint drawbuffer, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ColorMaski)(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteFramebuffers)(GLsizei n, const GLuint * framebuffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteRenderbuffers)(GLsizei n, const GLuint * renderbuffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteVertexArrays)(GLsizei n, const GLuint * arrays);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Disablei)(GLenum target, GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Enablei)(GLenum target, GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *EndConditionalRender)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *EndTransformFeedback)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FlushMappedBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferRenderbuffer)(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferTexture1D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferTexture2D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferTexture3D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferTextureLayer)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenFramebuffers)(GLsizei n, GLuint * framebuffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenRenderbuffers)(GLsizei n, GLuint * renderbuffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenVertexArrays)(GLsizei n, GLuint * arrays);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenerateMipmap)(GLenum target);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetBooleani_v)(GLenum target, GLuint index, GLboolean * data);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetFragDataLocation)(GLuint program, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetFramebufferAttachmentParameteriv)(GLenum target, GLenum attachment, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetIntegeri_v)(GLenum target, GLuint index, GLint * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetRenderbufferParameteriv)(GLenum target, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern const GLubyte * (CODEGEN_FUNCPTR *GetStringi)(GLenum name, GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexParameterIiv)(GLenum target, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTexParameterIuiv)(GLenum target, GLenum pname, GLuint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetTransformFeedbackVarying)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLsizei * size, GLenum * type, GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetUniformuiv)(GLuint program, GLint location, GLuint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribIiv)(GLuint index, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribIuiv)(GLuint index, GLenum pname, GLuint * params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsEnabledi)(GLenum target, GLuint index);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsFramebuffer)(GLuint framebuffer);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsRenderbuffer)(GLuint renderbuffer);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsVertexArray)(GLuint ren_array);
			PROPITIOUS_EXPORT extern void * (CODEGEN_FUNCPTR *MapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *RenderbufferStorage)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *RenderbufferStorageMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexParameterIiv)(GLenum target, GLenum pname, const GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexParameterIuiv)(GLenum target, GLenum pname, const GLuint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TransformFeedbackVaryings)(GLuint program, GLsizei count, const GLchar *const* varyings, GLenum bufferMode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1ui)(GLint location, GLuint v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1uiv)(GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2ui)(GLint location, GLuint v0, GLuint v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2uiv)(GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3ui)(GLint location, GLuint v0, GLuint v1, GLuint v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3uiv)(GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4ui)(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4uiv)(GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI1i)(GLuint index, GLint x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI1iv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI1ui)(GLuint index, GLuint x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI1uiv)(GLuint index, const GLuint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI2i)(GLuint index, GLint x, GLint y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI2iv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI2ui)(GLuint index, GLuint x, GLuint y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI2uiv)(GLuint index, const GLuint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI3i)(GLuint index, GLint x, GLint y, GLint z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI3iv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI3ui)(GLuint index, GLuint x, GLuint y, GLuint z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI3uiv)(GLuint index, const GLuint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4bv)(GLuint index, const GLbyte * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4i)(GLuint index, GLint x, GLint y, GLint z, GLint w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4iv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4sv)(GLuint index, const GLshort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4ubv)(GLuint index, const GLubyte * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4ui)(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4uiv)(GLuint index, const GLuint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribI4usv)(GLuint index, const GLushort * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribIPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const void * pointer);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyBufferSubData)(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawArraysInstanced)(GLenum mode, GLint first, GLsizei count, GLsizei instancecount);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElementsInstanced)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveUniformBlockName)(GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformBlockName);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveUniformBlockiv)(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveUniformName)(GLuint program, GLuint uniformIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformName);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveUniformsiv)(GLuint program, GLsizei uniformCount, const GLuint * uniformIndices, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *GetUniformBlockIndex)(GLuint program, const GLchar * uniformBlockName);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetUniformIndices)(GLuint program, GLsizei uniformCount, const GLchar *const* uniformNames, GLuint * uniformIndices);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PrimitiveRestartIndex)(GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexBuffer)(GLenum target, GLenum internalformat, GLuint buffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformBlockBinding)(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);

			PROPITIOUS_EXPORT extern GLenum(CODEGEN_FUNCPTR *ClientWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteSync)(GLsync sync);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElementsBaseVertex)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLint basevertex);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElementsInstancedBaseVertex)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLint basevertex);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawRangeElementsBaseVertex)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices, GLint basevertex);
			PROPITIOUS_EXPORT extern GLsync(CODEGEN_FUNCPTR *FenceSync)(GLenum condition, GLbitfield flags);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferTexture)(GLenum target, GLenum attachment, GLuint texture, GLint level);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetBufferParameteri64v)(GLenum target, GLenum pname, GLint64 * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetInteger64i_v)(GLenum target, GLuint index, GLint64 * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetInteger64v)(GLenum pname, GLint64 * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetMultisamplefv)(GLenum pname, GLuint index, GLfloat * val);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetSynciv)(GLsync sync, GLenum pname, GLsizei bufSize, GLsizei * length, GLint * values);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsSync)(GLsync sync);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MultiDrawElementsBaseVertex)(GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei drawcount, const GLint * basevertex);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProvokingVertex)(GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SampleMaski)(GLuint maskNumber, GLbitfield mask);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexImage2DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexImage3DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *WaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindFragDataLocationIndexed)(GLuint program, GLuint colorNumber, GLuint index, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindSampler)(GLuint unit, GLuint sampler);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteSamplers)(GLsizei count, const GLuint * samplers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenSamplers)(GLsizei count, GLuint * samplers);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetFragDataIndex)(GLuint program, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetQueryObjecti64v)(GLuint id, GLenum pname, GLint64 * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetQueryObjectui64v)(GLuint id, GLenum pname, GLuint64 * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetSamplerParameterIiv)(GLuint sampler, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetSamplerParameterIuiv)(GLuint sampler, GLenum pname, GLuint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetSamplerParameterfv)(GLuint sampler, GLenum pname, GLfloat * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetSamplerParameteriv)(GLuint sampler, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsSampler)(GLuint sampler);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *QueryCounter)(GLuint id, GLenum target);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SamplerParameterIiv)(GLuint sampler, GLenum pname, const GLint * param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SamplerParameterIuiv)(GLuint sampler, GLenum pname, const GLuint * param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SamplerParameterf)(GLuint sampler, GLenum pname, GLfloat param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SamplerParameterfv)(GLuint sampler, GLenum pname, const GLfloat * param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SamplerParameteri)(GLuint sampler, GLenum pname, GLint param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *SamplerParameteriv)(GLuint sampler, GLenum pname, const GLint * param);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribDivisor)(GLuint index, GLuint divisor);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP1ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP1uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP2ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP2uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP3ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP3uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP4ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribP4uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BeginQueryIndexed)(GLenum target, GLuint index, GLuint id);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindTransformFeedback)(GLenum target, GLuint id);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendEquationSeparatei)(GLuint buf, GLenum modeRGB, GLenum modeAlpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendEquationi)(GLuint buf, GLenum mode);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendFuncSeparatei)(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BlendFunci)(GLuint buf, GLenum src, GLenum dst);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteTransformFeedbacks)(GLsizei n, const GLuint * ids);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawArraysIndirect)(GLenum mode, const void * indirect);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElementsIndirect)(GLenum mode, GLenum type, const void * indirect);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawTransformFeedback)(GLenum mode, GLuint id);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawTransformFeedbackStream)(GLenum mode, GLuint id, GLuint stream);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *EndQueryIndexed)(GLenum target, GLuint index);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenTransformFeedbacks)(GLsizei n, GLuint * ids);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveSubroutineName)(GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei * length, GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveSubroutineUniformName)(GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei * length, GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveSubroutineUniformiv)(GLuint program, GLenum shadertype, GLuint index, GLenum pname, GLint * values);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramStageiv)(GLuint program, GLenum shadertype, GLenum pname, GLint * values);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetQueryIndexediv)(GLenum target, GLuint index, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *GetSubroutineIndex)(GLuint program, GLenum shadertype, const GLchar * name);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetSubroutineUniformLocation)(GLuint program, GLenum shadertype, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetUniformSubroutineuiv)(GLenum shadertype, GLint location, GLuint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetUniformdv)(GLuint program, GLint location, GLdouble * params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsTransformFeedback)(GLuint id);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MinSampleShading)(GLfloat value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PatchParameterfv)(GLenum pname, const GLfloat * values);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PatchParameteri)(GLenum pname, GLint value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PauseTransformFeedback)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ResumeTransformFeedback)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1d)(GLint location, GLdouble x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform1dv)(GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2d)(GLint location, GLdouble x, GLdouble y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform2dv)(GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3d)(GLint location, GLdouble x, GLdouble y, GLdouble z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform3dv)(GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4d)(GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *Uniform4dv)(GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix2x3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix2x4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix3x2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix3x4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix4x2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformMatrix4x3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UniformSubroutinesuiv)(GLenum shadertype, GLsizei count, const GLuint * indices);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ActiveShaderProgram)(GLuint pipeline, GLuint program);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindProgramPipeline)(GLuint pipeline);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearDepthf)(GLfloat d);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *CreateShaderProgramv)(GLenum type, GLsizei count, const GLchar *const* strings);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DeleteProgramPipelines)(GLsizei n, const GLuint * pipelines);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DepthRangeArrayv)(GLuint first, GLsizei count, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DepthRangeIndexed)(GLuint index, GLdouble n, GLdouble f);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DepthRangef)(GLfloat n, GLfloat f);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GenProgramPipelines)(GLsizei n, GLuint * pipelines);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetDoublei_v)(GLenum target, GLuint index, GLdouble * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetFloati_v)(GLenum target, GLuint index, GLfloat * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramBinary)(GLuint program, GLsizei bufSize, GLsizei * length, GLenum * binaryFormat, void * binary);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramPipelineInfoLog)(GLuint pipeline, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramPipelineiv)(GLuint pipeline, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetShaderPrecisionFormat)(GLenum shadertype, GLenum precisiontype, GLint * range, GLint * precision);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetVertexAttribLdv)(GLuint index, GLenum pname, GLdouble * params);
			PROPITIOUS_EXPORT extern GLboolean(CODEGEN_FUNCPTR *IsProgramPipeline)(GLuint pipeline);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramBinary)(GLuint program, GLenum binaryFormat, const void * binary, GLsizei length);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramParameteri)(GLuint program, GLenum pname, GLint value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1d)(GLuint program, GLint location, GLdouble v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1f)(GLuint program, GLint location, GLfloat v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1i)(GLuint program, GLint location, GLint v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1ui)(GLuint program, GLint location, GLuint v0);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform1uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2d)(GLuint program, GLint location, GLdouble v0, GLdouble v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2f)(GLuint program, GLint location, GLfloat v0, GLfloat v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2i)(GLuint program, GLint location, GLint v0, GLint v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2ui)(GLuint program, GLint location, GLuint v0, GLuint v1);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform2uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3i)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3ui)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform3uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2, GLdouble v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4i)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4ui)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniform4uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix2dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix2fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix2x3dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix2x3fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix2x4dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix2x4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix3dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix3fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix3x2dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix3x2fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix3x4dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix3x4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix4dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix4x2dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix4x2fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix4x3dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ProgramUniformMatrix4x3fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ReleaseShaderCompiler)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ScissorArrayv)(GLuint first, GLsizei count, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ScissorIndexed)(GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ScissorIndexedv)(GLuint index, const GLint * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ShaderBinary)(GLsizei count, const GLuint * shaders, GLenum binaryformat, const void * binary, GLsizei length);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *UseProgramStages)(GLuint pipeline, GLbitfield stages, GLuint program);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ValidateProgramPipeline)(GLuint pipeline);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL1d)(GLuint index, GLdouble x);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL1dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL2d)(GLuint index, GLdouble x, GLdouble y);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL2dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL3dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribL4dv)(GLuint index, const GLdouble * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribLPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const void * pointer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ViewportArrayv)(GLuint first, GLsizei count, const GLfloat * v);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ViewportIndexedf)(GLuint index, GLfloat x, GLfloat y, GLfloat w, GLfloat h);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ViewportIndexedfv)(GLuint index, const GLfloat * v);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindImageTexture)(GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawArraysInstancedBaseInstance)(GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElementsInstancedBaseInstance)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLuint baseinstance);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawElementsInstancedBaseVertexBaseInstance)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawTransformFeedbackInstanced)(GLenum mode, GLuint id, GLsizei instancecount);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DrawTransformFeedbackStreamInstanced)(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetActiveAtomicCounterBufferiv)(GLuint program, GLuint bufferIndex, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetInternalformativ)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MemoryBarrier)(GLbitfield barriers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexStorage1D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexStorage2D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexStorage3D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindVertexBuffer)(GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearBufferData)(GLenum target, GLenum internalformat, GLenum format, GLenum type, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearBufferSubData)(GLenum target, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *CopyImageSubData)(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DebugMessageCallback)(GLDEBUGPROC callback, const void * userParam);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DebugMessageControl)(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DebugMessageInsert)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar * buf);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DispatchCompute)(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *DispatchComputeIndirect)(GLintptr indirect);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *FramebufferParameteri)(GLenum target, GLenum pname, GLint param);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *GetDebugMessageLog)(GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * severities, GLsizei * lengths, GLchar * messageLog);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetFramebufferParameteriv)(GLenum target, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetInternalformati64v)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint64 * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetObjectLabel)(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei * length, GLchar * label);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetObjectPtrLabel)(const void * ptr, GLsizei bufSize, GLsizei * length, GLchar * label);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramInterfaceiv)(GLuint program, GLenum programInterface, GLenum pname, GLint * params);
			PROPITIOUS_EXPORT extern GLuint(CODEGEN_FUNCPTR *GetProgramResourceIndex)(GLuint program, GLenum programInterface, const GLchar * name);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetProgramResourceLocation)(GLuint program, GLenum programInterface, const GLchar * name);
			PROPITIOUS_EXPORT extern GLint(CODEGEN_FUNCPTR *GetProgramResourceLocationIndex)(GLuint program, GLenum programInterface, const GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramResourceName)(GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei * length, GLchar * name);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *GetProgramResourceiv)(GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei bufSize, GLsizei * length, GLint * params);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *InvalidateBufferData)(GLuint buffer);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *InvalidateBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr length);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *InvalidateFramebuffer)(GLenum target, GLsizei numAttachments, const GLenum * attachments);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *InvalidateSubFramebuffer)(GLenum target, GLsizei numAttachments, const GLenum * attachments, GLint x, GLint y, GLsizei width, GLsizei height);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *InvalidateTexImage)(GLuint texture, GLint level);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *InvalidateTexSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MultiDrawArraysIndirect)(GLenum mode, const void * indirect, GLsizei drawcount, GLsizei stride);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *MultiDrawElementsIndirect)(GLenum mode, GLenum type, const void * indirect, GLsizei drawcount, GLsizei stride);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ObjectLabel)(GLenum identifier, GLuint name, GLsizei length, const GLchar * label);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ObjectPtrLabel)(const void * ptr, GLsizei length, const GLchar * label);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PopDebugGroup)(void);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *PushDebugGroup)(GLenum source, GLuint id, GLsizei length, const GLchar * message);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ShaderStorageBlockBinding)(GLuint program, GLuint storageBlockIndex, GLuint storageBlockBinding);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexBufferRange)(GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexStorage2DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TexStorage3DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *TextureView)(GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat, GLuint minlevel, GLuint numlevels, GLuint minlayer, GLuint numlayers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribBinding)(GLuint attribindex, GLuint bindingindex);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribFormat)(GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribIFormat)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexAttribLFormat)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *VertexBindingDivisor)(GLuint bindingindex, GLuint divisor);

			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindBuffersBase)(GLenum target, GLuint first, GLsizei count, const GLuint * buffers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindBuffersRange)(GLenum target, GLuint first, GLsizei count, const GLuint * buffers, const GLintptr * offsets, const GLsizeiptr * sizes);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindImageTextures)(GLuint first, GLsizei count, const GLuint * textures);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindSamplers)(GLuint first, GLsizei count, const GLuint * samplers);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindTextures)(GLuint first, GLsizei count, const GLuint * textures);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BindVertexBuffers)(GLuint first, GLsizei count, const GLuint * buffers, const GLintptr * offsets, const GLsizei * strides);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *BufferStorage)(GLenum target, GLsizeiptr size, const void * data, GLbitfield flags);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearTexImage)(GLuint texture, GLint level, GLenum format, GLenum type, const void * data);
			PROPITIOUS_EXPORT extern void (CODEGEN_FUNCPTR *ClearTexSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void * data);
		...
		namespace System
		{
			...
			Extentions::LoadTest LoadFunctions();
